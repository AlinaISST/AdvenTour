      ...
      body: Center(
        child: ListView(padding: const EdgeInsets.all(20.0), children: <Widget>[
          ...
          Image.asset("assets/images/logo-black.png",
              width: _isSmallScreen ? 100 : 200,
              height: _isSmallScreen ? 100 : 200),
          const SizedBox(
            height: 20,
          ),
          Card(
            ...
            child: Column(
              children: <Widget>[
                buildListTile(context, "What is ExploreEra about?",
                    Icons.spatial_audio_off_outlined),
                const Divider(),
                const SizedBox(width: 8),
                const ListTile(
                  title: Text(
                      'ExploreEra is an initiative that aims to empower young women between the age of 15-25 by providing sexual health information in rural regions, focusing on menstrual health and contraception products.',

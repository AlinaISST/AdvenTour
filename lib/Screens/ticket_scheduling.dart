...
import 'package:explore_era/Screens/schedule.dart';
import 'package:explore_era/Screens/sign_in.dart';
import 'package:explore_era/Screens/scheduled_booking.dart';
...
class TicketScheduling extends StatefulWidget {
  const TicketScheduling({super.key});

  @override
  State<TicketScheduling> createState() => _TicketSchedulingState();
}

class _TicketSchedulingState extends State<TicketScheduling> {
                          ...
                          child: Column(
                            children: [
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child: currentUserNotification[index].flightAirline == 'PIA'
                                                                              ? Image.asset(
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    'Welcome ${userNotifier.user.userName ?? ""} to Schedule your Ticket.',
                                    style: GoogleFonts.raleway(
                                      fontSize: 20,
                                      color: const Color(0xffFFFFFF),
                                      fontWeight: FontWeight.bold,
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    if (selectedAirLine != null &&
                                      ...
                                      flightNotifier
                                          .addAirLine(selectedAirLine ?? "PIA");
